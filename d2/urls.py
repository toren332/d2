...
from profiles.views import Users, Groups, Students, Teachers, StudentsGroups,GroupsFromStudent, StudentsFromGroup
...
router.register('api/v0/students_from_group', StudentsFromGroup, basename='StudentsFromGroup')
router.register('api/v0/groups_from_student', GroupsFromStudent, basename='GroupsFromStudent')
